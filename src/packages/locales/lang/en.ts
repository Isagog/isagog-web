export default {
  ...
  careers: {
    invito: {
      ...
      factContract: "Freelance (Italian VAT number)",
      factPay: "€1,800–2,000 per month",
      whyLabel: "WHY ISAGOG",
    ...
    candidatura: {
      ...
      termMode: "Professional freelance collaboration with an Italian VAT number (partita IVA), fully remote.",
      termPayLabel: "Compensation",
      termPay: "€1,800–2,000 per month.",
