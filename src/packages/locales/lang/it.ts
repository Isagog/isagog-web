export default {
  ...
  careers: {
    invito: {
      ...
      factsLabel: "In sintesi",
      factRemote: "Full remote",
      factContract: "Partita IVA",
      factPay: "1.800–2.000 € al mese",
    ...
    candidatura: {
      ...
      termMode: "Collaborazione professionale con partita IVA, in full remote.",
      termPayLabel: "Compenso",
      termPay: "1.800–2.000 € mensili.",
